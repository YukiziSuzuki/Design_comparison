            ...
            <div class="row">
                <div class="col text-center mt-5">
                    <form action="end.php" method="post">
						...
						<input type="hidden" name="select_2" value=<?php echo $select_2; ?>>
                        <input type="hidden" name="select_3" value=<?php echo $select_3; ?>>
                        <input type="hidden" name="select_4" value=<?php echo $select_4; ?>>
                        <input type="hidden" name="select_5" value="A">
                ...
                <div class="col text-center mt-5">
                    <form action="end.php" method="post">
                        ...
                        <input type="hidden" name="select_3" value=<?php echo $select_3; ?>>
                        <input type="hidden" name="select_4" value=<?php echo $select_4; ?>>
                        <input type="hidden" name="select_5" value="B">
